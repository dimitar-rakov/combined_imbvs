...
/// ToDO Kinetic support check?
  ...
  // Hardware interfaces
  hardware_interface::JointStateInterface joint_state_handle_;
  ...
  // configuration
  size_t n_joints_ = 7; // safe magic number, the kuka lwr 4 has 7 joints
  ...
  std::vector<double>
  joint_msr_position_,
  joint_msr_position_prev_,
  joint_msr_velocity_,
  joint_msr_velocity_prev_,
  joint_msr_effort_,
  joint_msr_stiffness_,
  joint_msr_damping_,
  joint_cmd_position_,
  joint_cmd_velocity_,
  joint_cmd_stiffness_,
  joint_cmd_damping_,
  joint_cmd_effort_;
